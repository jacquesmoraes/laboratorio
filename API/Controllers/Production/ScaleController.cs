...
namespace API.Controllers.Production
{
    ...
    public class ScaleController ( IGenericService<Scale> service, IMapper mapper ) : BaseApiController
    {
        ...
        public async Task<IActionResult> GetAll ( )
        {
            ...
            return Ok ( _mapper.Map<IEnumerable<ScaleDto>> ( result ) );
        }
        ...
        public async Task<IActionResult> GetById ( int id )
        {
            ...
            return entity == null ? NotFound ( ) : Ok ( _mapper.Map<ScaleDto> ( entity ) );
        }
        ...
        public async Task<IActionResult> Create ( [FromBody] CreateScaleDto dto )
        {
            ...
            return CreatedAtAction ( nameof ( GetById ), new { id = created.Id }, _mapper.Map<ScaleDto> ( created ) );
        }
