...
public class ClientAreaServiceTests
{
    ...
    private readonly Mock<IGenericRepository<ServiceOrderSchedule>> _scheduleRepoMock = new();
    ...
    {
        _clientRepoMock.Setup(r => r.GetEntityWithSpecWithoutTrackingAsync(It.IsAny<ISpecification<Client>>()))
